...
public class Board {
   ...
   // Butonların renkleri
   private static final Color buttonColor = new Color(0, 255, 0);
   private static final Color buttonTextColor = StdDraw.BLACK;
   ...
   public int[][] getNumbers() {
      ...
      int index = 0;
      // Flat diziyi 2D diziye dönüştür
      for (int row = 0; row < 3; row++) {
         for (int col = 0; col < 3; col++) {
            numbers2D[row][col] = numbers[index++];
         }
      }
      return numbers2D;
   }
